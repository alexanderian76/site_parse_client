    ...
    <div ref={ref => container.current = ref} style={{opacity: 1, marginTop: navbarHeight.height}}>
      ...
      // marginLeft: (container.current.offsetWidth - (window.innerWidth/2 < 300 ? 300 : window.innerWidth/1.15)) / 2,
          ...
          //  paddingBottom: container.current.offsetHeight == null ? 0 : container.current.offsetHeight/ 12
                    ...
                    }}>Мы команда разработчиков, любящих свое дело.
                       Мы не только хотим удовлетворить потребностям вас и вашего бизнеса, автоматизировать все необходимые процессы,
                        ...
                        <div style={{paddingTop: 15}}>С нами вы будете уделять время развитию бизнеса, а не рутинным процессам. Все системы вашей компании будут работать как часы.</div>
