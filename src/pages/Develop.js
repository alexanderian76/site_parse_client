...
<div>Разработаем web-приложение для любых нужд</div>
    ...
    <meta name="keywords" content="заказать сайт web-application web-приложение"/>
        ...
        <a style={{
                    ...
                    }}>Если вам нужен сайт или web приложение для автоматизации бизнеса и ведения учета различного рода данных, то вы обратились по адресу. Создадим web приложение с учетом всех ваших требований. Если вам необходимо построить сложную логику или математическую модель для обработки данных, у нас работают лучшие математики, способные решить любую задачу. Цена каждого проекта индивидуальна и зависит от сложности и объема задач, но можем с уверенностью сказать, что предложим вам самые выгодные условия.</a>
        <a style={{
                     // width: currentWidth,
                      marginTop: typeof(currentWidth) === "string" ? 10 : 30,
                      display: 'inline-block',
                      ...
                      marginRight: typeof(currentWidth) === "string" ? 10 : currentWidth / 3,
                      fontSize: typeof(currentWidth) === "string" ? 17 : 19
                    }}>При разработке мы используем React. В серверной части, в зависимости от задач, используем либо .NET, либо Python, либо Node.js</a>
        <img src={devPic} style={{marginTop: 30, height: window.innerHeight < 400 ? 200 : window.innerHeight/3,width: '100%',  objectFit: 'contain'}}/>
                   ...
                   fontSize: typeof(currentWidth) === "string" ? 15 : 20,
                      ...
                      <li>
                      разработка программного обеспечения для автоматизации специфических бизнес-процессов для малых и средних предприятий;
                      </li>
                      <li>
